          ...
          <c:forEach items="" var="">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                ...
                <small class="text-muted">${product.itemCategory}</small>
                <br>
                <small class="text-muted">${product.itemCondition}</small>
              </div>
              <span class="text-muted">￦${product.itemPrice}</span>
              <div>
              <!-- if getproduct에서 가져온 available상태가 구매가능 일때는 색상 : #f9bf3b
              if get~~~~~~~~~~~~~ ITEM_METHOD가 직접판매, 현금결제일때는 : 채팅으로 연결되도록
              	 ~~~~~~~~~~~~~~~~ ITEM_METHOD가 카드결제 	    일때는   : 바로 주문서로  -->
				 <button class="btn btn-lg btn-block" style="background-color: #f9bf3b; color: white;" id="p_togglebtn">대화하기</button>
...
<!-- 내가 사려고 선택한 물건 목록들 c:forEach 끝-->            
            ...
            <li class="list-group-item d-flex justify-content-between">
              <span>최종금액 (WON)</span>
              <strong>이부분은 필요할지 모르겠네...</strong>
            </li>
          </ul>

          <form class="card p-2">
            <div class="input-group">
              <input type="text" class="col-md-10 form-control ml-4" placeholder="쿠폰 코드">
