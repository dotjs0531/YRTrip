...
function selectPay(ele){
	if (ele.value == 'other') {
		...
		insertPartner.partnerPay.value = '';
	} else {
		var partnerPay = document.getElementById("partnerPay");
		insertPartner.partnerPay.value = $("#selpartnerPay option:selected").text();
        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-sm-6" style="min-width: 700px">
					<form action="./insertPartner" name="insertPartner" method="post">
						<div style="min-height: 450px;">
							<table class="table table-bordered table-striped" style="text-align: center;">
								<thead>
									<tr>
										<th colspan="6" style="background-color: #eeeeee; text-align: center; padding: 10px;">
											<h4 style="font-family: 'NanumSquareRoundB';">동행 게시판 글 등록</h4>
										</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td style="width:20%">
											<select name="partnerClass" class="form-control" style="display:inline" required>
									...
									<tr>
										<td colspan="2" style="width:30%">
											<div style="float:left">
												...
												<input type="text" class="form-control" id="autocompleteTinfoList" placeholder="떠나고 싶은 여행지를 입력해주세요." autocomplete="on" style="width:350px;" name="searchTinfoListbox">
									...
									<tr>
										<td colspan="6">
											여행기간 <input type="date" id="partnerStart" name="partnerStart" class="form-control" style="width:44%; display:inline" required>
											 ~ <input type="date" id="partnerEnd" name="partnerEnd" class="form-control" style="width:44%; display:inline" required>
										</td>
									</tr>
									<tr>
										<td colspan="10"><textarea class="form-control" placeholder="글 내용" name="partnerContent" maxlength="2048" style="height: 200px" required></textarea></td>
									</tr>
								</tbody>
							</table>
						</div>
