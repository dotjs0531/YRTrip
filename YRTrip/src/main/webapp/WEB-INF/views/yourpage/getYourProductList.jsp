                    ...
                    <div class="single-pricing-table">
                        ...
                        <div style="padding-bottom:20px">
                            <a href="./getYourProductList?sellerId=${user.userId}"
                            	   style="color:black; text-decoration:none !important;"><strong>상품</strong></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6" style="min-width:700px">
                			...
                			<table style="width:100%" tabel-layout:fixed">
                				<tr>
                					<td style="text-align:center; width:50%"><h2>
                						<a href="./getYourProductList?sellerId=${user.userId}"
                						   style="color:black; font-family: 'NanumSquareRoundEB';">너의 상품</a></h2></td>
                					<td style="text-align:center; width:50%"><h2>
                						<a href="./getYourReviewList?sellerId=${user.userId}"
                						   style="color:#666666; font-family: 'NanumSquareRoundB';">너가 받은 리뷰</a></h2></td>
                				</tr>
                			</table>
            			</div>
                	...
                	<div>
						<div class="container card" style="width:100%; min-height:420px">
							<!-- Normal Demo-->
							<c:forEach items="${YourProductList}" var="product">
	                    ...
	                    <!-- 페이지 번호 -->
	                    <c:if test="${not empty YourProductList}">
	                    <div>
