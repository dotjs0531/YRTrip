...
public class PartnerController {
	...
	public String getPartnerBoardList(Model model, PartnerBoardVO vo) {
	...
	public String getBoard(Model model, PartnerBoardVO vo) {
	...
	public String insertPartnerBoard(PartnerBoardVO vo) { // 커맨드 객체
	...
	public String updateBoardform(Model model, PartnerBoardVO vo) {
	...
	public String updateBoard(PartnerBoardVO vo) {
	...
	public String deleteBoard(PartnerBoardVO vo) {
	...
	public String deleteBoardList(PartnerBoardVO vo) {
